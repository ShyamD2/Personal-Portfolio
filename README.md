...
<div align="center">
  ...
  <div>
    <a href="https://github.com/ShyamD2/Personal-Portfolio/blob/main/LICENSE.txt"><img src="https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge" alt="MIT License" /></a>
    ...
    <a href="https://aws.amazon.com/"><img src="https://img.shields.io/badge/AWS-Cloud%20Architecture-FF9900?style=for-the-badge&logo=amazon-aws&logoColor=white" alt="AWS" /></a>
    <a href="https://kubernetes.io/"><img src="https://img.shields.io/badge/Kubernetes-Custom%20Scheduler-326CE5?style=for-the-badge&logo=kubernetes&logoColor=white" alt="Kubernetes" /></a>
    <a href="https://www.terraform.io/"><img src="https://img.shields.io/badge/Terraform-100%25%20Codified-844FBA?style=for-the-badge&logo=terraform&logoColor=white" alt="Terraform" /></a>
  </div>
...
```mermaid
graph TD
  User([Recruiter / Engineering Leader]) --> Hero[Hero Cockpit & Thanos Engine]
  Hero --> FastTrack[1. Recruiter Fast-Track Role Selector]
  Hero --> Showcase[2. SRE Multi-Mode Architecture Showcase]
  
  subgraph Showcase Cockpit
    Showcase --> K8s[☸️ KubeForecast PreScore Scheduler]
    Showcase --> Chaos[🐒 Break My Cluster Chaos Monkey]
    Showcase --> FinOps[💰 FinOps EC2 Cloud Cost Calculator]
    Showcase --> Topology[🗺️ AWS & Terraform 4-Tier Topology]
    Showcase --> Video[🎬 Live Hardware Demonstration Demo]
  end

  Hero --> SREBar[3. Live SRE Telemetry Bar & Web Audio Engine]
  Hero --> Dossier[4. Tailored Specialization Dossiers]
```
